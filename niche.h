...
typedef struct {
  ...
  char      toxicpregnancy;               // induces toxic pregnancy
...
typedef struct patch {
  ...
  u64b              nf;                               // The number of females currently in this patch
  u64b              nm;                               // The number of males currently in this patch
  ...
  char              inocpatch;                        // flag, if it is an inoculation patch
  char              monitorgen;                       // flag, if it is a monitoring gen
  char              femscentstrength;                 // female scent value of the patch
  //u64b              femscentID;                     // ID of the female who left the scent most recently
  char              malscentstrength;                 // male scent value of the patch
  //u64b              malscentID;                     // ID of the male who left the scent most recently
} Patch, *pPatch;
